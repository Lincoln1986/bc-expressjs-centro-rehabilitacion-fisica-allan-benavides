...
import type { SingleResponse, PaginatedResponse, Session } from '../types/index.js';
...
export async function getAll(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    res.json(result satisfies PaginatedResponse<Session>);
  } catch (err) {
    next(err);
  }
}
...
export async function getById(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    res.json({ data: session } satisfies SingleResponse<Session>);
  } catch (err) {
    next(err);
  }
}
...
export async function create(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    res.status(201).json({ data: session } satisfies SingleResponse<Session>);
  } catch (err) {
    next(err);
  }
}
